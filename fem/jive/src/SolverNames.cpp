...
const char* SolverNames::INELASTIC         = "inelastic";
const char* SolverNames::LOADINGCOUNT      = "loadingCount";
const char* SolverNames::UNLOADINGCOUNT    = "unloadingCount";
...
const char* SolverNames::GET_MAT_STATE     = "getMaterialState";
